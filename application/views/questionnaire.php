      ...
      <?= form_open('alumni/add','POST'); ?>
        <div class="slide current" data-name="personal-information">
          ...
          <div class="field">
            ...
            <input type="text" name="personal_information[specified_country]" placeholder="Country/State of Present Address" class="hidden" value="<?=set_field_value('personal_information', 'specified_country', null, null); ?>" />
          </div>
          <div class="field">
