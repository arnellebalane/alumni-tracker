    ...
    <div class="content">
          ...
          <div class="educational-history-list">
            ...
            <?php foreach ($other_degree as $other) : ?>
              <div class="educational-history">              
                <?=anchor('enumerator/deleteOtherDegree/'.$user_id.'/'.$other->other_degree_id.'/'.$page, '[Delete This Degree]')?>
                <div class="field">
                  <label>Degree</label>
                  <h4><?=$other->degree?></h4>
                  <div class="editable hidden">
      ...
      <div class="hidden" id="job-form-template">
        ...
        <div class="field inline">
          ...
          -->
          <input type="range" name="another_job[{{index}}][job_satisfaction]" min="1" max="10" step="1" value="6" />
          <span>6</span>
        </div>
        <div class="field">
          <label>Why or why not satisfied?</label>
